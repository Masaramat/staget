...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>Staget : Savings processor</title>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Adas<span>he</span></a>
                    <h5 class="text-muted fw-normal mb-4">Welcome back! Log in to your account.</h5>
                    <form class="forms-sample" method="POST" action="{{ route('login') }}">
                        @csrf
                      <div class="mb-3">
                        <label for="login" class="form-label">Email/Phone</label>
                        <input name="login" type="text" class="form-control" id="login" placeholder="Email/Phone" autofocus required autocomplete="username">
                      </div>
                      <div class="mb-3">
