$(function() {
  ...
  // New Customers Chart
  if($('#indTotalSavingsChart').length) {
    var options1 = {
      chart: {
        type: "line",
        height: 60,
    ...
    new ApexCharts(document.querySelector("#indTotalSavingsChart"),options1).render();
  }
  // New Customers Chart - END
  ...
  if($('#ordersChart').length) {
    if($('#depositsYears').length){
      var years = $('#depositsYears').data('years');
      var deposits = $('#depositsData').data('deposits');
  ...
  if($('#indYearSavingsChart').length) {
    ...
    new ApexCharts(document.querySelector("#indYearSavingsChart"),options2).render();
  }
  // Orders Chart - END
  ...
  if($('#growthChart').length) {
    ...
    new ApexCharts(document.querySelector("#indIntChart"),options3).render();
  }
  // Growth Chart - END
